...
| 🐧 **Linux** (x64) | [📦 下载 AppImage](https://github.com/suyiiyii/AutoGLM-GUI/releases/download/v1.0.1/AutoGLM.GUI-1.0.1.AppImage) \| [deb](https://github.com/suyiiyii/AutoGLM-GUI/releases/download/v1.0.1/autoglm-gui_1.0.1_amd64.deb) \| [tar.gz](https://github.com/suyiiyii/AutoGLM-GUI/releases/download/v1.0.1/AutoGLM.GUI-1.0.1.tar.gz) | 通用格式，支持主流发行版 |
